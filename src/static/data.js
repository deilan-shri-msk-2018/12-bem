export default [
  ...
  },
  {
    ...
    titleColor: '#3a2210',
    image: "img/2.png",
    description: "Ещё до релиза у Kingdom Come: Deliverance вышло два патча «первого дня». Обновление до версии 1.01 требовало загрузить 23 ГБ. Для сравнения, вся игра на ПК, согласно данным Steam, занимает около 40 ГБ.",
    size: "m",
  },
  {
